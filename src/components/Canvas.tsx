...
interface CanvasProps {
  ...
  onUpdateThought: (id: string, updates: Partial<NewThoughtData>) => void;
}
...
const Canvas = ({
  ...
  useEffect(() => {
    if (cy && thoughts.length > 0) {
      ...
      const tagGroups: { [key: string]: Thought[] } = {};
      ...
      // Run layout
      const layoutOptions: { [key: string]: LayoutOptions } = {
        fcose: {
          name: 'fcose',
          quality: 'proof',
          randomize: false,
