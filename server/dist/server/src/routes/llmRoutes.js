...
const llmAuditLogger_1 = require("../../../core/logger/llmAuditLogger"); // Corrected import
const router = (0, express_1.Router)();
// Initialize LLM Task Runner with Ollama executor
const ollamaExecutor = new OllamaExecutor_1.OllamaExecutor(process.env.OLLAMA_DEFAULT_MODEL || 'llama2'); // Corrected constructor call
