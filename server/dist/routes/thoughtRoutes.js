...
router.post('/:thoughtId/segments', async (req, res) => {
    try {
        const ideaManager = req.app.locals.ideaManager;
        const { thoughtId } = req.params;
...
router.put('/:thoughtId/segments/:segmentId', async (req, res) => {
    try {
        const ideaManager = req.app.locals.ideaManager;
...
router.delete('/:thoughtId/segments/:segmentId', async (req, res) => {
    try {
        const ideaManager = req.app.locals.ideaManager;
        const { thoughtId, segmentId } = req.params;
