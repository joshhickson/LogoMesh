...
3.  **Enforced Node.js Version**: To prevent this issue for future contributors, the following changes were made:
    ...
    - **`README.md`**: The documentation was updated with new instructions and direct links for installing the required Node.js version, C++ Build Tools, and Docker Desktop.
