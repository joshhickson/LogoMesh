...
| **2.1** | **Security** | **Minimal DBOM Schema (Spec-First)**<br>Define formal JSON schema for Decision Bill of Materials. | **OPEN** (was Hadiza) | `OPEN` | [Research Paper](../../../Legacy-Pillars/Research/Theory/20251115-Research_Paper-Contextual_Debt-A_Software_Liability.md) | [Contracts Package](../../../../packages/contracts/) |
