...
------------------------------------------------------------------------
1. Add an evaluation-output schema document (short): [docs/EVAL_OUTPUT_SCHEMA.md](../../01-Architecture/Specs/Evaluation-Output-Schema.md) — DONE.
...
4. Draft a short metric spec: [docs/CONTEXTUAL_DEBT_SPEC.md](../../01-Architecture/Specs/Contextual-Debt-Spec.md) — DONE (concise algorithm + worked example).
...
---------------------------------------------------------
- [docs/EVAL_OUTPUT_SCHEMA.md](../../01-Architecture/Specs/Evaluation-Output-Schema.md) (short doc + example JSON) — added.
...
- [docs/EVAL_OUTPUT_SCHEMA.md](../../01-Architecture/Specs/Evaluation-Output-Schema.md) — evaluation JSON schema and example.
...
2. Add [docs/CONTEXTUAL_DEBT_SPEC.md](../../01-Architecture/Specs/Contextual-Debt-Spec.md) enhancements: uncertainty propagation and weighting experiments (optional but useful for research-grade analysis).
