...
- [docs/GAP_ANALYSIS_FOR_DATASCIENTIST.md](./GAP_ANALYSIS_FOR_DATASCIENTIST.md) — this doc.
- [docs/PROJECT_STATUS.md](./PROJECT_STATUS.md) — high-level project context and verified status.
- [docs/EVAL_OUTPUT_SCHEMA.md](./EVAL_OUTPUT_SCHEMA.md) — schema for evaluation JSON and a short example.
...
-------------------------------------------------
1. Output format & example dataset: Addressed — [docs/EVAL_OUTPUT_SCHEMA.md](./EVAL_OUTPUT_SCHEMA.md) and `docs/onboarding/example-evaluation-report.json` now exist.
...
5. Metrics definitions: Addressed — [docs/CONTEXTUAL_DEBT_SPEC.md](./CONTEXTUAL_DEBT_SPEC.md) documents the current aggregation logic and includes a worked example.

Actionable, prioritized tasks (first 7-day sprint for a data scientist)
------------------------------------------------------------------------
1. Add an evaluation-output schema document (short): [docs/EVAL_OUTPUT_SCHEMA.md](./EVAL_OUTPUT_SCHEMA.md) — DONE.
...
4. Draft a short metric spec: [docs/CONTEXTUAL_DEBT_SPEC.md](./CONTEXTUAL_DEBT_SPEC.md) — DONE (concise algorithm + worked example).
...
---------------------------------------------------------
- [docs/EVAL_OUTPUT_SCHEMA.md](./EVAL_OUTPUT_SCHEMA.md) (short doc + example JSON) — added.
...
- [docs/EVAL_OUTPUT_SCHEMA.md](./EVAL_OUTPUT_SCHEMA.md) — evaluation JSON schema and example.
...
--------------------------------
- [docs/EVAL_OUTPUT_SCHEMA.md](./EVAL_OUTPUT_SCHEMA.md) — canonical evaluation JSON schema + example.
- `docs/onboarding/example-evaluation-report.json` — concrete example JSON.
- [docs/CONTEXTUAL_DEBT_SPEC.md](./CONTEXTUAL_DEBT_SPEC.md) — exact aggregation algorithm and worked example.
...
- [x] Gap-analysis & onboarding doc ([docs/GAP_ANALYSIS_FOR_DATASCIENTIST.md](./GAP_ANALYSIS_FOR_DATASCIENTIST.md)) is reachable from the README.
- [x] Metric spec present ([docs/CONTEXTUAL_DEBT_SPEC.md](./CONTEXTUAL_DEBT_SPEC.md)).
...
2. Add [docs/CONTEXTUAL_DEBT_SPEC.md](./CONTEXTUAL_DEBT_SPEC.md) enhancements: uncertainty propagation and weighting experiments (optional but useful for research-grade analysis).
