...
The previous implementation, as detailed in [../../04-Operations/Intent-Log/Technical/20251113_RECOVERY_PLAN.md](../../04-Operations/Intent-Log/Technical/20251113_RECOVERY_PLAN.md), relied on simpler mechanisms (e.g., complexity metrics, basic pass/fail test capture). This new approach elevates our core intellectual property by grounding each component of the CIS in hard technology: vector-based semantic analysis, graph theory, and semantic test coverage.
...
[../IP/20251118-proposed-Section-2.2.md](../IP/20251118-proposed-Section-2.2.md)
...
**Action Item:** The [../../04-Operations/Intent-Log/Technical/20251113_RECOVERY_PLAN.md](../../04-Operations/Intent-Log/Technical/20251113_RECOVERY_PLAN.md) will be updated to replace the contents of "Workstream 1: Harden Core Analyzer Logic" with the following:
