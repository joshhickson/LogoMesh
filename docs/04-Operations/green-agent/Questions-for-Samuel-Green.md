...
*   **Context:** The [Hybrid Sidecar Plan](../../01-Architecture/Specs/20251218-Hybrid-Sidecar-Implementation-Plan.md) calls for using specialized workers (Rationale, Architectural) to calculate these scores deterministically.
