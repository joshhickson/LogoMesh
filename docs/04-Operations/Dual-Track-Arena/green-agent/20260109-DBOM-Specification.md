...
> All claims in this document have been empirically verified against the codebase and file-reviews as of 2026-01-30. For the most current, empirical file-level documentation, see [file-reviews/green/analyzer.md](../file-reviews/green/analyzer.md) and [src/green_logic/agent.py](../../../src/green_logic/agent.py).
status: ACTIVE
type: Spec
created: 2026-01-09
...
See: [file-reviews/green/analyzer.md](../file-reviews/green/analyzer.md), [src/green_logic/agent.py](../../../src/green_logic/agent.py)
...
See: [src/green_logic/agent.py](../../../src/green_logic/agent.py) (`generate_dbom` method)
...
See: [file-reviews/green/scoring.md](../file-reviews/green/scoring.md), [file-reviews/green/compare_vectors.md](../file-reviews/green/compare_vectors.md)

### Signature (`sigma_judge`)
- **Current State:** Simulated (`SIG_GREEN_{battle_id}_{h_delta[:8]}`) as implemented in [src/green_logic/agent.py](../../../src/green_logic/agent.py).
...
## Status (Empirically Verified 2026-01-30)
- **Status:** **Implemented and up-to-date.**
- **Location:** [src/green_logic/agent.py](../../../src/green_logic/agent.py) (`generate_dbom` method)
